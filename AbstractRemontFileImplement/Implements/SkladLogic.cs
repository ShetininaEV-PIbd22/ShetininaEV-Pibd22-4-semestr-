...
namespace AbstractRemontFileImplement.Implements
{
    public class SkladLogic : ISkladLogic
    {
        ...
        private SkladViewModel CreateViewModel(Sklad warehouse)
        {

            Dictionary<int, (string, int)> warehouseComponents = new Dictionary<int, (string, int)>();

            foreach (var wc in source.SkladComponents)
            {
                if (wc.SkladId == warehouse.Id)
                {
            ...
            {
                Id = warehouse.Id,
                SkladName = warehouse.SkladName,
                SkladComponents = warehouseComponents
            };
        }
